...
model = keras.Sequential([
    layers.Embedding(vocal_size, 16),
...
history=model.fit(partial_train_data,partial_train_labels,batch_size=512,epochs=20, validation_data=(validation_data,validation_label))
